      ...
      <div className='sobre-container'>
        ...
        <div className='sobre-card'>
          ...
          <div className='sobre-card-information'>
            ...
            <SobreInfo text={`Comecei a programar no Julho de 2019 criando coisas em python, até que resolvi criar algo que precisava de uma interface bonita, foi quando aprendi HTML, CSS e peguei o gancho para aprender JavaScript, jQuery e Electron, pois o que eu queria era criar um aplicativo desktop (para computadores). Foquei bastante em desenvolvimento front-end (parte visual das aplicações) ao longo do tempo, e hoje consigo construir uma aplicaçao completa utilizando tecnologias como Nodejs, ReactJS, React Native e outros. Participei de alguns treinamentos seletivos de empresas juniores e bolsistas, trabalhando em grupo com outros desenvolvedores com metodologias ageis e sempre caminhando em busca do próximo nível.  Atualmente estou aprofudando meus estudos em React e frameworks/bibliotecas para criar aplicações web e mobile.`} />          
